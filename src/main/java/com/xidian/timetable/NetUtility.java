...
import com.xidian.mastergrade.CourseInfo;
...
public class NetUtility {
    ...
    public static boolean doLoginAction(UserInfo userInfo){
        ...
        //    System.out.println("After Login");
         //   System.out.println(EntityUtils.toString(response.getEntity()));
            ...
            //System.out.println("login---"+headers[0].toString().split(" ")[1]);
            return true;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public static boolean getGradeWebCookie(UserInfo userInfo){
    ...
    public static boolean getGradeInfo(UserInfo userInfo){
    ...
    public static boolean getCourseInfo(UserInfo userInfo){

        HttpGet httpGet = new HttpGet(NetConstans.COURSE_TABLE);
        httpGet.setConfig(HttpClientManager.getRequestConfig());
        httpGet.setHeader("Host", "ids.xidian.edu.cn");
        httpGet.setHeader("User-Agent", "Mozilla/5.0 (Windows NT 6.1; WOW64; rv:39.0) Gecko/20100101 Firefox/39.0");
        httpGet.setHeader("Accept", "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8");
        ...
        try {
            ...
            String webStr = null;
            try {
                webStr = EntityUtils.toString(response.getEntity());
                //System.out.println(webStr);
                Document document = Jsoup.parse(webStr);
                DocOperate.getStuCourse(document, userInfo);
            } catch (IOException e) {
                e.printStackTrace();
    ...
    private static boolean parseUserInfo(UserInfo userInfo, HttpResponse httpResponse){
        String webStr = null;
        try {
    ...
    private static boolean parseGradeInfo(UserInfo userInfo, String webStr){
