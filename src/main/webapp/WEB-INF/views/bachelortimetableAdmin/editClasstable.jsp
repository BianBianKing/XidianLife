...
<body>
	...
	<br>
	 <div class="panel panel-info">
            ...
            <div class="panel-body" id="panelBody">
				...
				<input class="form-control {required:true,,messages:{required:'请输入班级名称'}" id="class_name" name="class_name" placeholder="请输入班级名称" value="${class_name }"/>
				</div>
			</div>
	</div>
	<div class="col-lg-10">
	...
	function get() {
		...
		$.ajax({ 
			type: "POST", 
			url: "editClasstable.action?class_id=${class_id}", 
