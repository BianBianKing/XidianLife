...
<body>
	...
	<div class="panel panel-info">
            ...
            <div class="panel-body" id="panelBody">
				...
				<input class="form-control {required:true,,messages:{required:'请输入班级名称'}" id="class_name" name="class_name" placeholder="请输入班级名称" />
				</div>
			</div>
	</div>
	 <div class="panel panel-info">
            ...
            <div class="panel-body" id="panelBody">
	            <div class="form-group">
				<input class="form-control {required:true,,messages:{required:'请输入教学周'}" id="class_name" name="class_name" placeholder="请输入教学周" />
				</div>
			</div>
	</div>
	<div class="col-lg-10">
	...
	var json = {};
	function get() {
		json.class_name = document.getElementById("class_name").value;
		json.college_id = ${college.id }//document.getElementById("college_id").value;
		$.ajax({ 
			type: "POST", 
			url: "addClasstable.action", 
