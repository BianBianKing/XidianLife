...
<body>
	...
	<br>
	 <div class="panel panel-info">
            ...
            <div class="panel-body" id="panelBody">
				...
				<input class="form-control {required:true,,messages:{required:'请输入学院名称'}" id="college_name" name="college_name" placeholder="请输入学院名称" value="${college_name }"/>
				</div>
			</div>
	</div>
	<div class="col-lg-10">
	...
	var json = {};
	function get() {
		json.college_name = document.getElementById("college_name").value;
		$.ajax({ 
			type: "POST", 
			url: "editCollege.action?college_id=${college_id}", 
