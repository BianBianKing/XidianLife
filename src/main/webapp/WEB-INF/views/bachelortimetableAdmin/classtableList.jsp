...
<body>
	...
	<div class="row">
	    <div class="col-lg-12">
	        <h1 class="page-header">${college_name }的班级信息</h1>
	    </div>
	    <!-- /.col-lg-12 -->
	</div>
        ...
        <div class="panel-body">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
	                    <c:forEach items="${classtableList }" var="node" varStatus="s">
				        	<tr>
			          	    <td><c:out value="${s.index+1 }"></c:out></td>
			          	    
					        <td><c:out value="${node.class_name }"></c:out></td>  
					        <td>
					        	<a href="editClasstable.htm?class_id=${node.id }" class="btn btn-info btn-xs">
                                    <i class="fa fa-pencil"></i>修改
                                </a>
                                <a href="delClasstable.action?class_id=${node.id }" class="btn btn-danger btn-xs">
                ...
                <a href="addClasstable.htm?college_id=${college_id }" class="btn btn-s-md btn-dark pull-right" style="margin-top:23px">添加班级</a> 
            </div>
            <!-- /.table-responsive -->
        </div>
        <!-- /.panel-body -->
