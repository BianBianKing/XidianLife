...
<body>
	...
	<br>
	 <div class="panel panel-info">
            ...
            <div class="panel-body" id="panelBody">
				...
				<input class="form-control {required:true,,messages:{required:'请输入标题'}" id="semester_name" name="semester_name" placeholder="请输入学期名称" value="${semester_name }"/>
				</div>
			</div>
	</div>
	<div class="col-lg-10">
	...
	function get() {
		...
		$.ajax({ 
			type: "POST", 
			url: "editSemester.action?semester_id=${semester_id}", 
